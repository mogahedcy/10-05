...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isArabic 
      ...
      : 'Contact Us | Deyar Jeddah Global - 24/7 Customer Service',
    description: isArabic
      ? 'تواصل مع فريق ديار جدة العالمية في جدة عبر الهاتف أو واتساب. خدمة عملاء متميزة 24/7، استشارة مجانية فورية.'
      : 'Contact Deyar Jeddah Global team in Jeddah via phone or WhatsApp. Excellent 24/7 customer service, instant free consultation.',
    keywords: isArabic
    ...
    openGraph: {
      title: isArabic ? 'تواصل معنا | ديار جدة العالمية' : 'Contact Us | Deyar Jeddah Global',
      description: isArabic 
        ? 'تواصل مع فريق ديار جدة العالمية في جدة. خدمة عملاء متميزة 24/7.'
        : 'Contact Deyar Jeddah Global team in Jeddah. Excellent 24/7 customer service.',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: isArabic ? 'تواصل معنا - ديار جدة العالمية' : 'Contact Us - Deyar Jeddah Global',
        },
      ],
    },
    twitter: {
