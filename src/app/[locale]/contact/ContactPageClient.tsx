...
export default function ContactPageClient({ locale }: ContactPageClientProps) {
  ...
  const structuredData = {
    ...
    "mainEntity": {
      "@type": "LocalBusiness",
      "name": isRTL ? "ديار جدة العالمية" : "Deyar Jeddah Global",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative rounded-lg overflow-hidden h-96 shadow-xl">
              <iframe
                ...
                title={isRTL ? "موقع ديار جدة العالمية في جدة" : "Deyar Jeddah Global location in Jeddah"}
              ...
              <div className={`absolute bottom-4 ${isRTL ? 'right-4' : 'left-4'} bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 max-w-xs`}>
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white">{isRTL ? 'ديار جدة العالمية' : 'Deyar Jeddah Global'}</h4>
